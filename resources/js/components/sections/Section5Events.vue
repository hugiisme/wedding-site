<template>
    ...
    >
        <div class="mx-auto w-full max-w-5xl">
            <p
                class="reveal text-center font-sans text-wedding-brown md:text-lg"
            >
                Khoảnh khắc đặc biệt này chỉ thực sự trọn vẹn khi có bạn cùng sẻ
                chia. Gia đình đã dành trọn tâm huyết chuẩn bị từng chi tiết
                nhỏ, với mong muốn mang lại không gian tiệc trọn vẹn nhất để
                tiếp đón những người thân thương. Mời bạn cùng điểm qua các
                thông tin chi tiết cho buổi tiệc sắp tới tại đây.
            </p>
            ...
            <div
                v-if="selected"
                class="reveal mt-10 grid grid-cols-1 gap-6 md:grid-cols-2"
            >
                <div
                    class="rounded-xl border border-wedding-sage/50 bg-white p-6 shadow-sm"
                >
                    <h3
                        class="font-serif text-xl font-semibold text-wedding-gold"
                    >
                        {{ selected.detail.title }}
                    </h3>
                    <p class="mt-2 text-wedding-brown">
                        {{ selected.detail.content }}
                    </p>
                    <p class="mt-2 text-sm text-wedding-brown/80">
                        {{ selected.detail.time }}
                    </p>
                    <p class="mt-1 font-medium text-wedding-brown">
                        {{ selected.detail.placeName }}
                    </p>
                    <p class="text-sm text-wedding-brown/80">
                ...
                <div
                    class="h-64 overflow-hidden rounded-xl border border-wedding-sage/50 md:h-80"
                >
                    <iframe
...
const events = ref([
    {
        ...
        detail: {
            ...
            embedUrl:
                "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d59587.977654479!2d105.845526!3d21.028511!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ab5e9a7b3e3d%3A0x3c3b3b3b3b3b3b3b!2sHanoi!5e0!3m2!1sen!2s!4v1234567890",
        },
    },
    {
        id: "tiec",
