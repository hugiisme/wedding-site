<template>
    ...
    >
        <div class="reveal filmstrip relative w-full max-w-4xl">
            ...
            >
                <div class="flex justify-around gap-1 px-2 py-0.5">
                    <span
                        v-for="n in 24"
                        :key="'t' + n"
                        class="h-2 w-2 rounded-sm bg-wedding-brown/60"
                    />
                </div>
            </div>
            <!-- Carousel -->
            <div
                class="relative flex items-center justify-center gap-2 px-4 pt-8 pb-4 md:gap-4 md:pt-10 md:pb-6"
            >
                <button
                    type="button"
                ...
                >
                    ...
                    >
                        <div
                            ...
                            :class="
                                i === 1
                                    ? 'scale-110 opacity-100 md:w-72'
                                    : 'w-20 opacity-70 md:w-40'
                            "
                            @click="
                                i === 1
            ...
            <div
                class="film-edge absolute bottom-0 left-0 right-0 h-4 bg-black/80"
                aria-hidden="true"
            >
                <div class="flex justify-around gap-1 px-2 py-0.5">
                    <span
